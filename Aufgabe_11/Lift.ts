namespace L11_Snowboardpiste_No4 {
    ...
    export class Lift extends Moveable {
        ...
        drawRopeTwo(_crc2: CanvasRenderingContext2D): void {
            _crc2.beginPath();
        ...
        drawLiftForward(_crc2: CanvasRenderingContext2D): void {
        ...
        drawLiftBackwards(_crc2: CanvasRenderingContext2D): void {
