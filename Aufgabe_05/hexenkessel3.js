...
var L05_Hexenkessel_No3;
(function (L05_Hexenkessel_No3) {
    let ingredients = "";
    let description = "";
    let instructions = "";
    let secInstruction = "";
    ...
    function handleLoad(_event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            L05_Hexenkessel_No3.generateContent(data);
            L05_Hexenkessel_No3.generatePriceContent(priceData);
    ...
    function sendOrder(_event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fetch("hexenkessel3.html?" + query.toString() + "&" + secQuery.toString() + "&" + thirQuery.toString() + "&" + fourthQuery.toString() + "&" + fithQuery.toString());
            alert("Order sent!");
        });
    }
...
})(L05_Hexenkessel_No3 || (L05_Hexenkessel_No3 = {}));
//# sourceMappingURL=hexenkessel3.js.map