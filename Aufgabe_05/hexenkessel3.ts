namespace L05_Hexenkessel_No3 {
    ...
    let fithForm: FormData = new FormData(document.forms[4]);
     ...
     await fetch("hexenkessel3.html?" + query.toString() +"&"+ secQuery.toString() +"&"+ thirQuery.toString() +"&"+ fourthQuery.toString() +"&"+ fithQuery.toString());
    alert("Order sent!");
     }
