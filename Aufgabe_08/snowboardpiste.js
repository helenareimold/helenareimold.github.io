var L08_Canvas_SnowboardPiste;
(function (L08_Canvas_SnowboardPiste) {
    ...
    function drawSnow(_position, _size) {
        ...
        for (let drawn = 0; drawn < snowflakes; drawn++) {
            crc2.save();
    ...
    function generateSnowPeople(_position, _size) {
        let snowboarder = 15;
        crc2.save();
        crc2.translate(_position.x, _position.y);
    ...
    function drawSnowPeople(_color) {
    ...
    function drawLiftPeople(_position, _size) {
...
})(L08_Canvas_SnowboardPiste || (L08_Canvas_SnowboardPiste = {}));
//# sourceMappingURL=snowboardpiste.js.map