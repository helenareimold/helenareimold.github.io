...
let number: number = parseInt(process.argv[2], Number(process.argv[3])); 
// Basis 16 Zahlensystem (Hexadezimal)
let hexadezimal: string = number.toString(Number(process.argv[4]));
let binär: string = number.toString(2);
